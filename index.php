...
$redisEndpoint = 'redis-12030.c1.us-east1-2.gce.cloud.redislabs.com';  // Reemplaza con tu endpoint
$redisPort = 12030;  // Puerto personalizado para Redis
...
try {
    ...
    exit; // Sale del script si no se pudo conectar a Redis
}

require_once("../conekta/lib/Conekta.php");
\Conekta\Conekta::setApiKey("key_EewOX5kf7bNTGQPYnDPCdBO");
\Conekta\Conekta::setApiVersion("6.0.1");

// Tu código de Conekta aquí
try {
    ...
    // Resto de tu código Conekta...

    // Ejemplo de almacenar en Redis
    $redis->set('mi_llave', 'mi_valor');
    $valorRedis = $redis->get('mi_llave');
    echo 'Valor en Redis: ' . $valorRedis;
			...
			<div class="opps-header">
				...
				<div class="opps-info">
					...
					<div class="opps-ammount">
						<h3>Monto a pagar</h3>
						<h2><?php echo  '$3500'.''?> <sup>MXN</sup></h2>
						<p>OXXO cobrará una comisión adicional al momento de realizar el pago.</p>
					</div>
				</div>
				<div class="opps-reference">
					<h3>Referencia</h3>
					<h1><?php echo '9800-0017-1636-70' ?> </h1>
				</div>
			</div>
